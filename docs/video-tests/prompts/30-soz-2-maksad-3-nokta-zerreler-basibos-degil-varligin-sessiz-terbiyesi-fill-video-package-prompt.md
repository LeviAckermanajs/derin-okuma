# Görev: 30.Söz - 2.Maksad - 3.Nokta video üretim scaffold dosyalarını doldur
...
```bash
python3 -m json.tool docs/video-tests/inputs/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi-landscape-full-video.json > /tmp/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi-landscape-metadata.json > /tmp/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi-shorts-package.json > /tmp/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi/metadata/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi-shorts-metadata.json > /tmp/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/30-soz-2-maksad-3-nokta-zerreler-basibos-degil-varligin-sessiz-terbiyesi/load-inputs/*.js; do
