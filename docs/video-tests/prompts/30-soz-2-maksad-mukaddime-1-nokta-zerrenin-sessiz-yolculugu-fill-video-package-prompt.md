# Görev: 30.Söz - 2.Maksad - Mukaddime - 1.Nokta video üretim scaffold dosyalarını doldur
...
```bash
python3 -m json.tool docs/video-tests/inputs/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu-landscape-full-video.json > /tmp/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu-landscape-metadata.json > /tmp/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu-shorts-package.json > /tmp/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu/metadata/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu-shorts-metadata.json > /tmp/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/30-soz-2-maksad-mukaddime-1-nokta-zerrenin-sessiz-yolculugu/load-inputs/*.js; do
