# Görev: 2.Şua - 1.Makam - 3.Meyve video üretim scaffold dosyalarını doldur
...
```bash
python3 -m json.tool docs/video-tests/inputs/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler-landscape-full-video.json > /tmp/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler-landscape-metadata.json > /tmp/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler-shorts-package.json > /tmp/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler/metadata/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler-shorts-metadata.json > /tmp/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/2-sua-1-makam-3-meyve-insan-tevhidle-neden-kainat-kadar-genisler/load-inputs/*.js; do
