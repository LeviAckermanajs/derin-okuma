# Görev: 26.Söz - 3.Mebhas video üretim scaffold dosyalarını doldur
...
```bash
python3 -m json.tool docs/video-tests/inputs/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar-landscape-full-video.json > /tmp/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar-landscape-metadata.json > /tmp/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar-shorts-package.json > /tmp/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar/metadata/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar-shorts-metadata.json > /tmp/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/26-soz-3-mebhas-her-sey-yaziliysa-insan-neden-rahatlar/load-inputs/*.js; do
