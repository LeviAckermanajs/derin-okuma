# Görev: 2.Şua - 1.Makam - 1.Meyve video üretim scaffold dosyalarını doldur
...
```bash
python3 -m json.tool docs/video-tests/inputs/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis-landscape-full-video.json > /tmp/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis-landscape-metadata.json > /tmp/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis-shorts-package.json > /tmp/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis/metadata/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis-shorts-metadata.json > /tmp/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/2-sua-1-makam-1-meyve-tevhid-daginik-gorunen-hayati-birlestiren-bakis/load-inputs/*.js; do
