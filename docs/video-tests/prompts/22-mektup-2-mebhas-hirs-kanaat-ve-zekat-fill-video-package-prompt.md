# Görev: 22. Mektup - 2. Mebhas video üretim scaffold dosyalarını doldur
...
```bash
python3 -m json.tool docs/video-tests/inputs/22-mektup-2-mebhas-hirs-kanaat-ve-zekat-landscape-full-video.json > /tmp/22-mektup-2-mebhas-hirs-kanaat-ve-zekat-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/22-mektup-2-mebhas-hirs-kanaat-ve-zekat-landscape-metadata.json > /tmp/22-mektup-2-mebhas-hirs-kanaat-ve-zekat-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/22-mektup-2-mebhas-hirs-kanaat-ve-zekat/22-mektup-2-mebhas-hirs-kanaat-ve-zekat-shorts-package.json > /tmp/22-mektup-2-mebhas-hirs-kanaat-ve-zekat-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/22-mektup-2-mebhas-hirs-kanaat-ve-zekat/metadata/22-mektup-2-mebhas-hirs-kanaat-ve-zekat-shorts-metadata.json > /tmp/22-mektup-2-mebhas-hirs-kanaat-ve-zekat-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/22-mektup-2-mebhas-hirs-kanaat-ve-zekat-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/22-mektup-2-mebhas-hirs-kanaat-ve-zekat/load-inputs/*.js; do
