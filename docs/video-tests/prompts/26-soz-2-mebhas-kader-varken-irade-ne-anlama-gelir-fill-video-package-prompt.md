# Görev: 26.Söz - 2.Makam video üretim scaffold dosyalarını doldur
...
```bash
python3 -m json.tool docs/video-tests/inputs/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir-landscape-full-video.json > /tmp/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir-landscape-metadata.json > /tmp/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir-shorts-package.json > /tmp/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir/metadata/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir-shorts-metadata.json > /tmp/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/26-soz-2-mebhas-kader-varken-irade-ne-anlama-gelir/load-inputs/*.js; do
