# Görev: 2.Şua - 1.Makam - 2.Meyve video üretim scaffold dosyalarını doldur
...
```bash
python3 -m json.tool docs/video-tests/inputs/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami-landscape-full-video.json > /tmp/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami-landscape-metadata.json > /tmp/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami-shorts-package.json > /tmp/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami/metadata/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami-shorts-metadata.json > /tmp/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/2-sua-1-makam-2-meyve-gelen-giden-varliklarin-anlami/load-inputs/*.js; do
