# Görev: 23. Söz - 2. Mebhas - 3. Nükte video üretim scaffold dosyalarını doldur

Bu görevde daha önce `npm run video:prep` ile oluşturulmuş scaffold dosyaları gerçek içerikle doldurulacak.

## Hedef Yazı

- Başlık: `23. Söz - 2. Mebhas - 3. Nükte`
- Slug: `23-soz-2-mebhas-3-nukte`
- Kaynak dosya: `src/content/blog/23-soz-2-mebhas-3-nükte.md`
- Gün: `day-21`
...
- `docs/video-tests/inputs/23-soz-2-mebhas-3-nukte-landscape-full-video.json`
- `docs/video-tests/inputs/23-soz-2-mebhas-3-nukte-landscape-load-input.js`
- `docs/video-tests/metadata/23-soz-2-mebhas-3-nukte-landscape-metadata.json`

### Shorts

- `docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/23-soz-2-mebhas-3-nukte-shorts-package.json`
- `docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/metadata/23-soz-2-mebhas-3-nukte-shorts-metadata.json`
- `docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/load-inputs/short-001-load-input.js`
- `docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/load-inputs/short-002-load-input.js`
- `docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/load-inputs/short-003-load-input.js`
- `docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/load-inputs/short-004-load-input.js`
- `docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/load-inputs/short-005-load-input.js`
- `docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/load-inputs/short-006-load-input.js`
...
```bash
python3 -m json.tool docs/video-tests/inputs/23-soz-2-mebhas-3-nukte-landscape-full-video.json > /tmp/23-soz-2-mebhas-3-nukte-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/23-soz-2-mebhas-3-nukte-landscape-metadata.json > /tmp/23-soz-2-mebhas-3-nukte-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/23-soz-2-mebhas-3-nukte-shorts-package.json > /tmp/23-soz-2-mebhas-3-nukte-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/metadata/23-soz-2-mebhas-3-nukte-shorts-metadata.json > /tmp/23-soz-2-mebhas-3-nukte-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/23-soz-2-mebhas-3-nukte-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/23-soz-2-mebhas-3-nukte/load-inputs/*.js; do
...
```bash
grep -RniE "bu metin|metnin|metinde|metne göre|metnin deyimiyle|bu noktada|şu cümle|verilen cevap|verilen örnek|yazar burada|kitap burada|burada anlatılmak istenen|bu bölüm" docs/video-tests/inputs/23-soz-2-mebhas-3-nukte* docs/video-tests/shorts/23-soz-2-mebhas-3-nukte || true
```
