# Görev: 20. Mektup - 2. Makam - 10. Kelime video üretim scaffold dosyalarını doldur
...
```bash
python3 -m json.tool docs/video-tests/inputs/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir-landscape-full-video.json > /tmp/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir-landscape-metadata.json > /tmp/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir-shorts-package.json > /tmp/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir/metadata/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir-shorts-metadata.json > /tmp/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/bir-bahari-yaratmak-neden-bir-cicek-kadar-kolaydir/load-inputs/*.js; do
