# Görev: 30.Söz - 2.Maksad - 2.Nokta video üretim scaffold dosyalarını doldur
...
```bash
python3 -m json.tool docs/video-tests/inputs/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi-landscape-full-video.json > /tmp/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi-landscape-metadata.json > /tmp/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi-shorts-package.json > /tmp/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi/metadata/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi-shorts-metadata.json > /tmp/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/30-soz-2-maksad-2-nokta-bir-zerrenin-sessiz-sahitligi/load-inputs/*.js; do
