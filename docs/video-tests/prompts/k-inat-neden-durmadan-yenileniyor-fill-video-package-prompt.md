# Görev: Kâinat Neden Durmadan Yenileniyor? video üretim scaffold dosyalarını doldur
...
for f in docs/video-tests/shorts/k-inat-neden-durmadan-yenileniyor/load-inputs/*.js; do
