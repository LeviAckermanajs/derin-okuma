# Görev: 20. Mektup - 1. Makam video üretim scaffold dosyalarını doldur

Bu görevde daha önce `npm run video:prep` ile oluşturulmuş scaffold dosyaları gerçek içerikle doldurulacak.

## Hedef Yazı

- Başlık: `20. Mektup - 1. Makam`
- Slug: `20-mektup-1-makam`
- Kaynak dosya: `src/content/blog/20-mektup-1-makam.md`
- Gün: `day-33`
...
- `docs/video-tests/inputs/20-mektup-1-makam-landscape-full-video.json`
- `docs/video-tests/inputs/20-mektup-1-makam-landscape-load-input.js`
- `docs/video-tests/metadata/20-mektup-1-makam-landscape-metadata.json`

### Shorts

- `docs/video-tests/shorts/20-mektup-1-makam/20-mektup-1-makam-shorts-package.json`
- `docs/video-tests/shorts/20-mektup-1-makam/metadata/20-mektup-1-makam-shorts-metadata.json`
- `docs/video-tests/shorts/20-mektup-1-makam/load-inputs/short-001-load-input.js`
- `docs/video-tests/shorts/20-mektup-1-makam/load-inputs/short-002-load-input.js`
- `docs/video-tests/shorts/20-mektup-1-makam/load-inputs/short-003-load-input.js`
- `docs/video-tests/shorts/20-mektup-1-makam/load-inputs/short-004-load-input.js`
- `docs/video-tests/shorts/20-mektup-1-makam/load-inputs/short-005-load-input.js`
- `docs/video-tests/shorts/20-mektup-1-makam/load-inputs/short-006-load-input.js`
...
```bash
python3 -m json.tool docs/video-tests/inputs/20-mektup-1-makam-landscape-full-video.json > /tmp/20-mektup-1-makam-landscape-json-check.json
python3 -m json.tool docs/video-tests/metadata/20-mektup-1-makam-landscape-metadata.json > /tmp/20-mektup-1-makam-landscape-metadata-check.json
python3 -m json.tool docs/video-tests/shorts/20-mektup-1-makam/20-mektup-1-makam-shorts-package.json > /tmp/20-mektup-1-makam-shorts-package-check.json
python3 -m json.tool docs/video-tests/shorts/20-mektup-1-makam/metadata/20-mektup-1-makam-shorts-metadata.json > /tmp/20-mektup-1-makam-shorts-metadata-check.json
```

JS syntax için:

```bash
node -e "new Function(require('fs').readFileSync('docs/video-tests/inputs/20-mektup-1-makam-landscape-load-input.js', 'utf8')); console.log('Landscape JS OK')"

for f in docs/video-tests/shorts/20-mektup-1-makam/load-inputs/*.js; do
...
```bash
grep -RniE "bu metin|metnin|metinde|metne göre|metnin deyimiyle|bu noktada|şu cümle|verilen cevap|verilen örnek|yazar burada|kitap burada|burada anlatılmak istenen|bu bölüm" docs/video-tests/inputs/20-mektup-1-makam* docs/video-tests/shorts/20-mektup-1-makam || true
```
