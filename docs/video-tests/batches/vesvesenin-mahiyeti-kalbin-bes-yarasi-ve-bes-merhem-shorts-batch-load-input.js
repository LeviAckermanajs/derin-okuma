...
const short001RawInput = {
  ...
  job: {
    ...
    job_id_hint: 'vesvesenin-mahiyeti-kalbin-bes-yarasi-ve-bes-merhem-short-001-day-27-day28-batch-context-a'
  },
  ...
  metadata: {
    batch_run_id: 'day28-batch-context-a',
    source: 'derin-okuma',
...
const short002RawInput = {
  ...
  job: {
    ...
    language: 'tr',
    author: 'Muhammet Yahya Ozer',
    job_id_hint: 'vesvesenin-mahiyeti-kalbin-bes-yarasi-ve-bes-merhem-short-002-day-27-day28-batch-context-a'
  },
  reuse_existing_audio: {
    enabled: false,
    audio_mode: 'single_track',
...
const short003RawInput = {
  ...
  job: {
    ...
    language: 'tr',
    author: 'Muhammet Yahya Ozer',
    job_id_hint: 'vesvesenin-mahiyeti-kalbin-bes-yarasi-ve-bes-merhem-short-003-day-27-day28-batch-context-a'
  },
  reuse_existing_audio: {
    enabled: false,
    audio_mode: 'single_track',
...
const short004RawInput = {
  ...
  job: {
    ...
    language: 'tr',
    author: 'Muhammet Yahya Ozer',
    job_id_hint: 'vesvesenin-mahiyeti-kalbin-bes-yarasi-ve-bes-merhem-short-004-day-27-day28-batch-context-a'
  },
  reuse_existing_audio: {
    enabled: false,
    audio_mode: 'single_track',
...
const short005RawInput = {
  ...
  job: {
    ...
    language: 'tr',
    author: 'Muhammet Yahya Ozer',
    job_id_hint: 'vesvesenin-mahiyeti-kalbin-bes-yarasi-ve-bes-merhem-short-005-day-27-day28-batch-context-a'
  },
  reuse_existing_audio: {
    enabled: false,
    audio_mode: 'single_track',
...
const short006RawInput = {
  ...
  job: {
    ...
    language: 'tr',
    author: 'Muhammet Yahya Ozer',
    job_id_hint: 'vesvesenin-mahiyeti-kalbin-bes-yarasi-ve-bes-merhem-short-006-day-27-day28-batch-context-a'
  },
  reuse_existing_audio: {
    enabled: false,
    audio_mode: 'single_track',
